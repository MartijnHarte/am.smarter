...
describe('Discovery', function() {
    ...
    describe('Scan', function() {
        ...
        it('If a socket is timing out', function(done) {
            var connectSocket = require('../../lib/discover' ).connectSocket
            connectSocket(2000, '192.168.1.2', new EventEmitter(), function ( status ) {
        ...
        it('If a device is not listening on port 2000', function(done) {
            ...
            connectSocket(2000, ip.address(), function(error, status) {
        ...
        it('If a device is listening on a port', function(done) {
            var connectSocket = require('../../lib/discover' ).connectSocket
            connectSocket(53, '8.8.8.8', function(error, status) {
                should.not.exist(error)
